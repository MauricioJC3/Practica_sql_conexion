...
<body class="bg-gray-100">
   ...
   <section class="shopping-cart mt-8">
    ...
    <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>" class="w-20 flex border border-gray-300 rounded-md px-2 py-1">
    <div class="flex space-x-2 mt-2">
        <input type="submit" name="update_cart" value="Actualizar" class="option-btn bg-blue-500 text-white font-bold rounded-md py-2 px-4 transition duration-300 hover:bg-blue-600 cursor-pointer">
        <input type="submit" name="#" value="Eliminar" class="option-btn bg-red-500 text-white font-bold rounded-md py-2 px-4 transition duration-300 hover:bg-red-600 cursor-pointer">
    </div>
</form>
         ...
         <?php
            ...
            echo '<p class="empty text-center text-gray-600">El carrito está vacío</p>';
         }
         ?>
      </div>
      ...
      <div class="cart-total mt-8">
         <p class="font-bold contenedor">Total: <span class="text-xl">$<?php echo $grand_total; ?></span></p>
         <div class="flex justify-center mt-4">
            <a href="ver_productos.php" class="option-btn bg-blue-500 text-white font-bold rounded-md mr-4 py-2 px-4 p-2 transition duration-300 hover:bg-blue-600 cursor-pointer">Continuar comprando</a>
