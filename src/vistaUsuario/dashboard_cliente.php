...
<!--"Bienvenido, <?php echo $_SESSION['nombre_cliente']; ?>!-->
    ...
    <br><br><br>
    <h1 class="font-bebas text-center text-5xl font-bold">Menú</h1>
<br>

<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-8 contenedor">
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
    ...
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
        <img class="image object-cover rounded-lg w-full h-full origin-center transition-transform duration-300 ease-in-out imagen-producto-zoom" src="../img/chuzo.jpg" alt="Carnes">
        <div class="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 p-4">
            <h2 class="text-lg font-semibold text-white">Carnes</h2>
        </div>
    </div>
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
        <img class="image object-cover rounded-lg w-full h-full origin-center transition-transform duration-300 ease-in-out imagen-producto-zoom" src="../img/empanada.jpg" alt="Empanadas">
        <div class="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 p-4">
            <h2 class="text-lg font-semibold text-white">Empanadas</h2>
        </div>
    </div>
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
        <img class="image object-cover rounded-lg w-full h-full origin-center transition-transform duration-300 ease-in-out imagen-producto-zoom" src="../img/perro.jpg" alt="Perro">
        <div class="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 p-4">
            <h2 class="text-lg font-semibold text-white">Perro</h2>
        </div>
    </div>
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
        <img class="image object-cover rounded-lg w-full h-full origin-center transition-transform duration-300 ease-in-out imagen-producto-zoom" src="../img/sand.jpg" alt="Sándwich">
        <div class="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 p-4">
            <h2 class="text-lg font-semibold text-white">Sándwich</h2>
        </div>
    </div>
    <div class="w-full h-full bg-white shadow-lg rounded-lg overflow-hidden relative transition duration-300 transform hover:-translate-y-1 hover:shadow-lg opacity-0">
        <img class="image object-cover rounded-lg w-full h-full origin-center transition-transform duration-300 ease-in-out imagen-producto-zoom" src="../img/pollo.jpg" alt="Pastel de pollo">
        <div class="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 p-4">
...
<section class="text-gray-600 bg-gray-500">
    <div class="mx-auto flex px-12 py-8 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="font-bebas text-amber-500 title-font text-5xl sm:text-5xl mb-4 font-medium">
            ...
            <div class="flex justify-center">
                <button class="font-bebas inline-flex text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg">Ver lugares</button>
                <button class="font-bebas ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Ver productos</button>
            </div>
        </div>
    ...
    <div class="container px-5 py-12 mx-auto">
        <div class="flex flex-wrap text-center justify-center">
            <div class="p-4 md:w-1/4 sm:w-1/2">
                <div class="px-6 py-6 transform transition duration-500 hover:scale-110">
                    <div class="flex justify-center">
                    ...
                    <h2 class="title-font font-regular text-2xl text-gray-900">Ubicación conveniente</h2>
                </div>
            </div>
            <div class="p-4 md:w-1/4 sm:w-1/2">
                <div class="px-6 py-6 transform transition duration-500 hover:scale-110">
                    ...
                    <h2 class="title-font font-regular text-2xl text-gray-900">Muy cerca de casa</h2>
                </div>
            </div>
            <div class="p-4 md:w-1/4 sm:w-1/2">
                <div class="px-6 py-6 transform transition duration-500 hover:scale-110">
                    ...
                    <h2 class="title-font font-regular text-2xl text-gray-900">El mejor servicio</h2>
                </div>
            </div>
        </div>
    </div>
...
<script src="../js/interacciones_menu.js"></script>
</body>
</html>